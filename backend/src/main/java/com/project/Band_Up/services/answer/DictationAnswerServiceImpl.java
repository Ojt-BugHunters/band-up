...
//
//
//    public DictationAnswerResponse submitAnswer(UUID attemptSectionId, UUID questionId, AnswerCreateRequest request) {
...
//        DictationAnswerResponse response = modelMapper.map(answer, DictationAnswerResponse.class);
