        ...
        <div className="space-y-8 p-4 sm:p-6 lg:p-8">
                ...
                <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center">
                    <div className="space-y-4 lg:w-2/3">
                        ...
                        <p className="max-w-2xl text-base text-white/80">
                            Keep rooms, blog content, and flashcards under
                            control from one command center. Track this
                            week&apos;s performance and react instantly.
                        </p>
                    </div>
            ...
            {(roomStatsErrorMessage ||
                ...
                <div className="text-destructive space-y-2 text-sm">
                    ...
                    {flashStatsErrorMessage && (
                        <p>
                            Failed to load flashcard stats:{' '}
                            {flashStatsErrorMessage}
                        </p>
                    )}
                </div>
            ...
            <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {insightCards.map((insight) => (
                    ...
                    >
                        ...
                        <div className="mt-4 inline-flex items-center gap-2 rounded-full bg-white/20 px-3 py-1 text-xs font-semibold tracking-wide uppercase">
                            <span
                                className={
                                    insight.positive
                                        ? 'text-emerald-100'
            ...
            <section>
                <div className="border-border/50 bg-card/60 rounded-3xl border p-6 shadow-lg">
